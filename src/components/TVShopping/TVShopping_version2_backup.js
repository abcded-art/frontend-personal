...
function TVShopping({ selectedDate, onScrollToCurrentHour, selectedMalls }) {
    ...
    const fetchData = useCallback(async () => {
        ...
        setHowManyFetchDataCalled(prevCount => prevCount + 1);
        try {
            ...
            console.log(`FetchData ${howManyFetchDataCalled}번째: 날짜 ${dateStr}의 쇼핑몰 ${selectedMalls} API 호출하는 데에 ${endTime-startTime}ms 걸렸다.`);
        }
